...
REM
REM Generated by Vivado on Mon Apr 06 01:11:21 +0530 2026
...
echo "xvlog --incr --relax -prj tm_tb_vlog.prj"
call xvlog  --incr --relax -prj tm_tb_vlog.prj -log xvlog.log
